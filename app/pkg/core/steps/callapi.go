...
func ExecuteCallAPI(config map[string]interface{}, ctx *context.ExecutionContext) error {
...
func buildRequest(config map[string]interface{}, endpoint string, ctx *context.ExecutionContext) *http.Request {
