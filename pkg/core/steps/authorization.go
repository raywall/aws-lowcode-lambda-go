...
func ExecuteAuthorization(config map[string]interface{}, ctx *context.ExecutionContext) error {
...
func buildAuthRequest(config map[string]interface{}, endpoint string, ctx *context.ExecutionContext) *http.Request {
